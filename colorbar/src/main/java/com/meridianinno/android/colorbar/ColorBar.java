package com.meridianinno.android.colorbar;
...
public class ColorBar extends View {
    ...
    private int[] mColorSeeds = new int[]{0xFFFFFF67, 0xFFE4F165, 0xFFC9E366, 0xFFACD666, 0xFF92C866, 0xFF76BB66, 0xFF5BAC67, 0xFF3C9E65, 0xFF1E8E66, 0xFF008166, 0xFF006666};
    ...
    protected void applyStyle(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        mContext = context;
        //get attributes
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ColorBar, defStyleAttr, defStyleRes);
        int colorsId = a.getResourceId(R.styleable.ColorBar_colorSeeds, 0);
        mMaxPosition = a.getInteger(R.styleable.ColorBar_maxPosition, 100);
        mColorBarPosition = a.getInteger(R.styleable.ColorBar_colorBarPosition, 0);
        mAlphaBarPosition = a.getInteger(R.styleable.ColorBar_alphaBarPosition, mAlphaMinPosition);
        mIsVertical = a.getBoolean(R.styleable.ColorBar_isVertical, false);
        mIsShowAlphaBar = a.getBoolean(R.styleable.ColorBar_showAlphaBar, false);
        mBackgroundColor = a.getColor(R.styleable.ColorBar_bgColor, Color.TRANSPARENT);
        mBarHeight = (int) a.getDimension(R.styleable.ColorBar_barHeight, (float) dp2px(2));
        mThumbHeight = (int) a.getDimension(R.styleable.ColorBar_thumbHeight, (float) dp2px(30));
        mBarMargin = (int) a.getDimension(R.styleable.ColorBar_barMargin, (float) dp2px(5));
        a.recycle();
/*
        if (colorsId != 0) {
